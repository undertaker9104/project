	...
	<div class="container" style="margin-top:10%;">
		<form class="well form-horizontal"
			...
			<fieldset>
				...
				<c:if test="${group_ArtVO.ship_locat == null }">
				<script>
				...
				<div class="form-group">
					...
					<div class="col-md-1 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon">
        						 <input id="address1" name="ship_locatbt" type="radio" aria-label="..." value="0" checked>
      						</span>
						</div>
					</div>
					...
					<div class="col-md-1 inputGroupContainer" >
						<div class="input-group">
							<span class="input-group-addon">
        						 <input id="address2" name="ship_locatbt" type="radio" aria-label="..." value="1">
      						</span>
						</div>
					</div>
				</div>
				...
				<div class="form-group" id="address3" style="display:none;">
					...
					<div class="col-md-4 inputGroupContainer" >
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="<%=(group_ArtVO.getShip_locat() == null) ? "" : group_ArtVO.getShip_locat()%>">
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						...
						<input type="hidden" name="request" value="${group_ArtVO.ord_id}">
						...
						<a href="<%=request.getContextPath()%>/front-end/groupart/grouplist.jsp"><button type="button" class="btn btn-warning">

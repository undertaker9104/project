...
<%
	...
	Integer cup =(Integer)request.getAttribute("cup"); 
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-8 text-center">			
			   <h1 align="center" ><font size="40px" color="red">您的訂單</font></h1>				  
...
<br>
    <div class="container-fluid total">
		<div class="row">
			...
			<span class="sum">&nbsp&nbsp&nbsp&nbsp&nbsp總計&nbsp:</span> &nbsp${cup}杯
			<br>
			<span class="dis">折扣後為&nbsp:&nbsp</span> ${total}元
    ...
    <FORM METHOD="post"	ACTION="<%=request.getContextPath()%>/front-end/group_order_detail.do">
	        ...
	        <button type="submit" class="btn-lg btn-primary active checkout1">確認送出</button>
	        </FORM>
<a href="<%=request.getContextPath()%>/front-end/grouporderdetail/group_detail.jsp" class="back">繼續訂購</a>	

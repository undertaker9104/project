...
//				System.out.println(mem_id);
		...
		if ("Record_value".equals(action)) {
			try {
				...
				RequestDispatcher successView = request.getRequestDispatcher("/front-end/mem/listOneMemRecord_value.jsp"); // 成功轉交listOneEmp.jsp
				successView.forward(request, response);
		...
		if ("getOne_For_Display".equals(action)) {
			...
			try {
				...
				RequestDispatcher successView = request.getRequestDispatcher("/back-end/mem/listOneMemRecord_value.jsp"); // 成功轉交listOneEmp.jsp
				successView.forward(request, response);
			} catch (Exception e) {
